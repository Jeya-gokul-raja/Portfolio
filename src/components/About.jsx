...
export default function About() {
  ...
  return (
    ...
    >
      ...
      {/* Text Section */}
      <div
        className="w-full sm:w-1/2 text-center sm:text-left px-3 sm:px-0"
        data-aos="fade-left"
      >
        <h1 className="font-bold mb-5 text-3xl sm:text-4xl text-white border-b-4 border-blue-800 w-fit mx-auto sm:mx-0">
          About Me
        </h1>
        <p className="text-white text-lg sm:text-2xl mb-5">{config.line1}</p>
        <p className="text-white text-lg sm:text-2xl mb-5">{config.line2}</p>
